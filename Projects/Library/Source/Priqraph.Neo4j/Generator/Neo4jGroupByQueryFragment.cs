...
public class Neo4jGroupByQueryFragment : DatabaseGroupByQueryFragment
{
    private Neo4jGroupByQueryFragment(GroupByProperty parameter)
    {
        Parameter = parameter;
    }

    public static Neo4jGroupByQueryFragment Create(GroupByProperty property) => new(property);
