...
public class Neo4jQueryableQueryObject<TObject> : DatabaseQueryableQueryObject<TObject,INeo4jQuery<TObject, Neo4jQueryOperationType>, Neo4jQueryResult, Neo4jQueryOperationType>, INeo4jQueryObject<TObject> where TObject : IQueryableObject
{
	private readonly IDatabaseObjectInfo _objectInfo;
    public override INeo4jQuery<TObject, Neo4jQueryOperationType> Query { get; }
    public Neo4jQueryableQueryObject(ICacheInfoCollection cacheInfoCollection) : base(cacheInfoCollection)
    {
		QueryResult = new();
    ...
    protected void FindNode(INeo4jQuery<TObject, Neo4jQueryOperationType> query)
    {
