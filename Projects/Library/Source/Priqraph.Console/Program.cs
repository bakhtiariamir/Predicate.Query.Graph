...
builder.RegisterType<CacheInfoCollection>().As<ICacheInfoCollection>().SingleInstance();
var container = builder.Build();
var databaseCacheInfoCollection = container.Resolve<ICacheInfoCollection>();
