...
public class QueryObjectBuilder<TObject> : IQueryObjectBuilder<TObject> where TObject : class
{
    ...
    public QueryObjectBuilder<TObject> SetSelecting(QueryObjectObjectSelecting<TObject> objectSelecting)
    {
        _object.Columns = objectSelecting.Return();
        return this;
    }

    public QueryObjectBuilder<TObject> SetFiltering(QueryObjectObjectFiltering<TObject> objectFiltering)
    {
        _object.Filters = objectFiltering.Return();
        return this;
    }

    public QueryObjectBuilder<TObject> SetSorting(QueryObjectObjectSorting<TObject> objectSorting)
    {
    ...
    public QueryObjectBuilder<TObject> SetGrouping(QueryObjectObjectGrouping<TObject> objectGrouping)
    {
